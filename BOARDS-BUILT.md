...
alone overnight, carrying what the first two had settled. **All five stop before paint**: every one is
...
| `opus55-redcut` | ctw | Opus 5.5 | **A nano mesa: a butte climbed by two sheer steps, and a wool in a box canyon**, from composed p8 seed 32, one wool a team on a U round a hole, an open 32-block crossing. The frontline climbs from the lip at 9 by a three-block step to a bench and a five-block face to the butte at 17, each crossed by a 45-degree stair at opposite ends so the climb turns along the bench; the U is walled at its front arm behind a neck, level across the wall, and falls into a canyon at 13 where the room opens. 104 × 192. **4 959 walked · 148 scrambled · 96 barrier · 4 faces**, 0.0% dead, export gate OPEN. Unpainted; a warm board, badlands planned |
| `opus55-lymedown` | ctw | Opus 5.5 | **A nano chalk down: rolling ground with nothing sheer on it**, from composed p8 seed 8, a g-shaped hub, one wool on an L at its back, a wide build band with one island. The hub leans from 9 at the band to 13 at its back; crowned downs swell on the west coast and at the wool arm's far corner, each skirt climbing at about its crown's rate; the hub dips toward a rounded hole. The only board of the run with **no** face at all. `FR9` stands on the 12-block front of `hub-t5`, kept rather than closing the notch beside it. 96 × 176. **5 924 walked · 0 scrambled · 0 barrier**, 5.7% dead, export gate OPEN. Unpainted; a pale board planned |
| `opus55-sedgefall` | ctw | Opus 5.5 | **A nano fen: low wet ground, a raised causeway, and two wools in reed beds**, from composed p8 seed 24, a ring hub, two wools on straight arms, one island. The only two-wool nano board: the side wool's arm carried a cell further out, which passed `WL9` and `WL10` together at once, and the hub widened a cell so its hole is twelve across (`WL12`). The frontline lies at 9 with two square peat cuttings either side of a causeway standing a block or two proud; a walkable bank rises to a turf knoll at 13; both walls on level ground; the arms fall to reed-bed yards at 11. 104 × 232. **6 259 walked · 308 scrambled · 8 barrier · 4 faces**, 0.0% dead, export gate OPEN. Unpainted; a dark board, swampland planned |
