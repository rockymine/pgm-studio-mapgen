...
| Folder | Mode | Author | What it is |
|---|---|---|---|
| `opus5c-emberhowe` | ctw | Opus 5 | **A dead volcano whose crater carries two neutral islands, and every gap on the board is 20 blocks.** 168 × 200. Each team holds a horseshoe of rim ending at `z 28`; the middle is 56 blocks of void with two islands at `x -44..-10` and `x 10..44`, `z -10..10`, and a build zone between every pair of things — limb to island, island to island, and the causeway joining a team's own two wool rooms across its bay. **Five crossings a team where the board began with one strait**, so a middle is held by arriving twice rather than once. The limb stands 12 blocks in front of its own spur, which is the ground a raid is met on. **Symmetric twice over** — `rot_180` between the teams and each half mirrored down `x = 0` — so both rooms sit at one z and cost the same walk from the hall, which `WL9` reads as a ratio of 1 and passes since amendment 44. Two wools a team on shelves hung off the outer coast, each with three faces on void and one bedrock wall on the approach↔mouth seam (`PL17`). Ground is pale ash over black rock on a slope stack cut at 20°/40°, with three **grove** patches of pure soil authored where the wood stands — `DR-ROOT` refuses a trunk on anything but grass or dirt, and soil scattered through an ash pattern seats a trunk and drops the crown on rock. **12 848 walked · 26 scrambled · 4 barrier · 2 faces**, evaluator **score 0, valid True**, 30 props placed and none declined, **1.6% dead** over 21 journeys, export gate OPEN |
...
### Opus 5.5 — two boards shaped with the author, three nano boards prepared alone (2026-09-22/23)

A collaboration run: the author decided each stage of the first two boards as it was built — the plan, then
the ground unpainted, then each correction — and the three nano boards were taken over and given their ground
alone overnight, carrying what the first two had settled, then laid out again to the author's review. **All five stop before paint**: every one is
driven, exported and walkable, and every one still wears the studio's grey fill and the built-in bedrock box
for its rooms, because theming is the next stage and the biome is decided with it.

What the run settled is written into `GENERATION-NOTES.md` rather than repeated here: a group straddling the
axis is solved on its `z < 0` half, a push whose ring holds no land lifts nothing, `PL17` passes a wall at a T
(filed as `TN22`), and a scarp with a corner stands a ridge past it. `reports/opus55-collab-1.md` is the run's
account, including the decisions taken without the author.

| Folder | Mode | Author | What it is |
|---|---|---|---|
| `opus55-millbank` | ctw | Opus 5.5 with the author | **A mill valley: two hamlets on raised banks across a river gorge**, from composed p20 seed 5. Two wools a team, each walled behind a neck; a river holm 32 × 32 in the gorge, twenty blocks off each lip, cut by a curved sheer bank to a river bed with a 45-degree stair into each bank. The frontline leans from 9 to a curved scarp standing seven blocks to the hamlet, with two stairs cut in; the hamlet leans on to its spawn; wool-a's approach swells on its coast, wool-b's tilts toward the spawn at its wall (`ST4` accepted by the author); the hub's hole is an irregular hexagon dipping at its lip. Rooms sixteen deep with a building seven deep at the back; spawn iron. 144 × 264. **10 179 walked · 312 scrambled · 280 barrier · 14 faces**, 0.0% dead, export gate OPEN. Unpainted; temperate green planned |
| `opus55-clasp` | ctw | Opus 5.5 with the author | **A clamp-wool board: a hub with a three-by-four hole beside a clamp whose mouth is a void**, from composed p20 seed 4 — hub widened toward the clamp, spawn brought level with the hub's middle, both wools walled behind necks and balanced by lengthening each a cell (`WL9` and `WL10` pinch at cell resolution). Two parallel islands on the build zone's edges, irregular inward, sixteen off each frontline. A lightning scarp across the frontline stated one mark per run, with contours that follow it; a canyon six deep through the piece between the hub hole and the clamp's mouth; a hollow the length of the clamp's back approach; the hub rising to its back with a swell at the corner by the spawn; a second scarp climbing to the back wool. 104 × 280. **8 635 walked · 422 scrambled · 236 barrier · 12 faces**, 0.0% dead, export gate OPEN. Unpainted; cold taiga planned |
| `opus55-redcut` | ctw | Opus 5.5, laid out by the author | **A nano mesa: a butte climbed by two sheer steps, and a wool in a box canyon at the spawn's end of its U**, from composed p8 seed 32, one wool a team on a U round a hole, an open 32-block crossing. The frontline climbs from the lip at 9 by a three-block step to a bench and a five-block face to the butte at 17, each crossed by a 45-degree stair at opposite ends so the climb turns along the bench; both arms of the U fall from the butte into a canyon at 13 along its spine. The room stands at the spine's spawn end, flush with its corner, and the wall stands across the spine's middle, level with the middle of the hole, on the canyon floor. 104 × 192. **4 966 walked · 150 scrambled · 96 barrier · 4 faces**, 0.0% dead, export gate OPEN. Unpainted; a warm board, badlands planned |
| `opus55-lymedown` | ctw | Opus 5.5, laid out by the author | **A nano chalk down: rolling ground with nothing sheer on it**, from composed p8 seed 8, a g-shaped hub, one wool on an L at its back, one island. The wool box leaves the back bar with its neck centred on the hub's hole and turns west, so the room's door and yard face the spawn. The build band runs only from the outer edge of the spawn's leg to the hole's far end, twelve cells, and the team units sit a cell west so it is centred and the two sides face squarely: a team leaving its spawn chooses a side of the hole. The hub leans from 9 at the band to 13 at its back; crowned downs swell on the west coast and at the L's corner; the hub dips toward a rounded hole. The only board of the run with **no** face at all. `FR9` stands on the 12-block front of `hub-t5`; the author rules it not valid on this board. 88 × 176. **5 900 walked · 0 scrambled · 0 barrier**, 0.0% dead, export gate OPEN. Unpainted; a pale board planned |
| `opus55-sedgefall` | ctw | Opus 5.5, laid out by the author | **A nano fen: low wet ground below a curved bank, and two wools in reed beds lined up on the hole**, from composed p8 seed 24, a ring hub, two wools, one island. Both approaches meet the hub opposite the middle of its hole — the back one straight behind it, the side one as deep as the hub's west side — each walled behind a neck; the back arm is long enough that its room stands sixteen behind its wall, which is also what balances the two walks from the spawn. The lip is centred on the axis so the two teams' lips face squarely, and the hub is a cell wider so its hole is twelve across (`WL12`). The frontline leans from 9 to a curved bank stated one mark per run, walked anywhere up to a turf knoll at 13, with contours that follow the bank and one soft reed pool; both walls on level ground; the arms fall to reed-bed yards at 11. 104 × 240. **7 062 walked · 0 scrambled · 0 barrier**, 0.0% dead, export gate OPEN. Unpainted; a dark board, swampland planned |

### Opus 5.5 — four destroy landscapes, relief only (2026-09-24)

**Four destroy boards drawn to one method: one plan at one height, the outline reshaped point by point, then
the ground stated in layers of relief.** Each plan is a spawn and one field at y20 with a 32-block build zone
between the teams; the compile fuses them into one shape, `field-20`, which `editShapes` reshapes and a bend
rounds. Nothing is painted and nothing is dressed. Each board states one kind of landform the capture set could
not hold, because a destroy board has the room.

**A second pass, after the author's review, unpinned the flat ground**: every lip is a wandering line rather
than a band, and Scarbutte was rebuilt. A third pass took the grain back off all four, because at a feature
size of 14–16 it read as noise. `reports/opus55-dtm-terrain.md` is the run's account.

| Board | Mode | Model | What it turned out to be |
|---|---|---|---|
| `opus55-kelderfell` | dtm | Opus 5.5 | **A fellside falling to the strait, broken by a curved scarp with a pass in it.** The spawn stands on a bench at y36 and the ground leans to a lip that wanders between 10 and 15. The scarp is ten short runs, one mark each, curving behind the monument's shelf and bowing out to the south, twelve blocks high and open at z −14…8 where the relaxation grades the pass; a stair line is cut up the south face. A fell massif is centred off the north-back coast so the board holds its flank to y69. The lower slope drains along a low spur and two swales, a tarn hollow sinks near the lip, a headland rises on the south coast and a knoll stands beside the monument. 268 × 156. **27 104 walked · 1 178 scrambled · 1 022 barrier · 6 faces**, 49.7% dead, export gate OPEN. `RL3` names the stair's side walls against the scarp (7 blocks at (−83, 19)) |
| `opus55-twingill` | dtm | Opus 5.5 | **A dale between two ridges, with its gill falling from the spawn's head to the strait.** The outline pinches at the dale head and flares at the lip. The dale floor is one line mark falling seventeen blocks, and the gill is a negative push, four blocks deep and eight across, carved along the same course after the solve. A long north ridge carries two coombes bitten into its inner flank, and the south side is a saddled pair of fells. Nothing pins the lip: the floor and the ridges' skirts carry the ground to the edge. The monument stands on a terrace on the south side, with a holm on the north bank lower down. 264 × 148. **24 025 walked · 1 745 scrambled · 108 barrier**, 51.5% dead, export gate OPEN. `RL5` at 22% level: a valley graded everywhere |
| `opus55-scarbutte` | dtm | Opus 5.5 | **A tableland whose curved rim breaks onto a rolling bench of buttes, split by a canyon with a ledge in each wall.** The tableland is one push of 12 over a spline ring with its back off the board, falloff 4 and roughness 0.5, so the rim wanders; a crown of 5 gives its top a fall toward the back, and it carries a swell. Its lift falls to 3 toward a pass on the north, which sags into a valley down to the bench. The bench is unpinned apart from the monument's shelf and a wandering lip, and it rolls over two swells and a pan. The canyon is two negative pushes: a trough of −4 the whole length, and a slot of −8 inside it in two reaches, with the trough alone left as the crossing at z −8…8. Four buttes stand on the bench, their sides wandering at roughness 0.5. 264 × 152. **22 463 walked · 1 848 scrambled · 2 750 barrier**, 58.1% dead, export gate OPEN. `RL3`'s 15-block step at (−132, −9) is the read comparing the spawn's footing before the push lifts it; a transect there reads level at 41. `RL6` is the crown against the cliff |
| `opus55-cinderhowe` | dtm | Opus 5.5 | **A caldera on the board's axis, breached twice, with the monument in its floor.** The island is rounded into lobes. The crater is a small bevelled floor at y13 and one closed rim line whose crest wanders between 33 and 44 and whose radius wanders between 23 and 29. It drops to 24 toward the spawn and to 15 toward the strait, so a defender enters from the west and an attacker through the east breach or over the rim. Three parasitic cones stand on the outer flank, a low lava tongue runs out of the east breach, and the lip wanders between 12 and 17. 280 × 164. **29 970 walked · 2 186 scrambled · 182 barrier**, 70.9% dead, export gate OPEN. The dead share is the monument on the centre line |
