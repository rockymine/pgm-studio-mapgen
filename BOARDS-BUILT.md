...
not hold, because a destroy board has the room. `reports/opus55-dtm-terrain.md` is the run's account.

| Board | Mode | Model | What it turned out to be |
|---|---|---|---|
| `opus55-kelderfell` | dtm | Opus 5.5 | **A fellside falling to the strait, broken by a scarp with a pass in it.** The spawn stands on a bench at y36 and the ground leans to a strand at 12. A twelve-block scarp crosses the board diagonally in four runs, one mark each, and is open at z −14…8 where the relaxation grades the pass; a stair line is cut up the south run's face. A fell massif is centred off the north-back coast so the board holds its flank to y68. A headland rises on the south coast, a tarn hollow sinks into the strand, and a knoll stands beside the monument's shelf below the scarp. 268 × 156. **27 160 walked · 1 150 scrambled · 994 barrier · 6 faces**, 49.7% dead, export gate OPEN. `RL3` names the stair's side walls against the scarp band (7 blocks at (−83, 19)) |
| `opus55-twingill` | dtm | Opus 5.5 | **A dale between two ridges, with its gill falling from the spawn's head to the strait.** The outline pinches at the dale head and flares at the lip. The dale floor is one line mark falling seventeen blocks, and the gill is a negative push, four blocks deep and eight across, carved along the same course after the solve. A long north ridge carries two coombes bitten into its inner flank; the south side is a saddled pair of fells. The monument stands on a terrace on the south side, with a holm on the north bank lower down. 264 × 148. **24 051 walked · 1 723 scrambled · 104 barrier**, 51.5% dead, export gate OPEN. `RL5` at 20% level: a valley graded everywhere |
| `opus55-scarbutte` | dtm | Opus 5.5 | **A tableland whose rim breaks onto a bench of buttes, split by a slot canyon.** The spawn's tableland at y38 ends at a twelve-block rim in four scarp runs, open at z −10…12 for the road down. The bench below is pinned at 26. A canyon ten blocks wide and twelve deep is carved into the bench in two reaches, with the bench left whole at z −8…8 as the one crossing. Four buttes are crownless pushes on short falloffs, so each stands off the bench on a face. The monument stands on the bench between the rim's foot and the canyon. 264 × 152. **24 197 walked · 306 scrambled · 2 558 barrier · 16 faces**, 58.1% dead, export gate OPEN. `RL2` names the barriers; they are the board |
| `opus55-cinderhowe` | dtm | Opus 5.5 | **A caldera on the board's axis, breached twice, with the monument in its floor.** The island is rounded into lobes. The crater is a floor at y13 and one closed rim line at 38 whose per-vertex heights drop to 24 toward the spawn and to 15 toward the strait, so a defender enters from the west and an attacker through the east breach or over the rim. Three parasitic cones stand on the outer flank, and a low lava tongue runs out of the east breach. 280 × 164. **28 826 walked · 2 414 scrambled · 1 098 barrier**, 70.9% dead, export gate OPEN. The dead share is the monument on the centre line |
