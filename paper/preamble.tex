...
% Routes and rule ids are long unbreakable words; a little emergency stretch keeps one
% from running past the margin instead of loosening the line that holds it.
...
% A route is monospaced and often longer than a line can hold. Breaking one mid-segment
% reads as two routes, so it is set unbroken and the surrounding paragraph is given room
...
\definecolor{boxEnvelope}   {HTML}{0072B2}
