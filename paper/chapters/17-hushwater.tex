...
Hushwater is also the board that exposed a studio defect, and the sequence is a
worked example of \cref{ch:refusals}'s argument about a predicate re-derived.
