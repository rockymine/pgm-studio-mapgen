...
\begin{subfigure}{0.31\textwidth}\centering
  \includegraphics[width=\linewidth]{themes/wg-theme-fell-section.png}
  \caption{\id{fell}: grown ground}\end{subfigure}\hfill
\begin{subfigure}{0.31\textwidth}\centering
  \includegraphics[width=\linewidth]{themes/wg-theme-works-section.png}
  \caption{\id{works}: quarry floor}\end{subfigure}\hfill
\begin{subfigure}{0.31\textwidth}\centering
  \includegraphics[width=\linewidth]{themes/wg-theme-yard-section.png}
  \caption{\id{yard}: made ground}\end{subfigure}

\medskip
\begin{subfigure}{0.31\textwidth}\centering
  \includegraphics[width=\linewidth]{themes/wg-theme-dock-section.png}
  \caption{\id{dock}: made, worked}\end{subfigure}\hfill
\begin{subfigure}{0.31\textwidth}\centering
  \includegraphics[width=\linewidth]{themes/wg-theme-kiln-section.png}
  \caption{\id{kiln}: one building}\end{subfigure}\hfill
\begin{subfigure}{0.31\textwidth}\centering
  \includegraphics[width=\linewidth]{themes/hw-theme-hush-section.png}
  \caption{\id{hush}: scoured rock}\end{subfigure}

\medskip
{\small\begin{minipage}{0.95\textwidth}
Six themes cut through, every one on the same test ground: a level shelf at the top
left, a stepped fall through the middle, and a second level shelf lower down on the
right, with void above it. Read a shelf against the steps beside it. In \id{fell}
both shelves take grass over coarse dirt over dirt and the steps between them take
bare stone, because the surface stack is banded on the \textbf{slope} axis and
nothing else about those columns differs. \id{works} and \id{dock} take worked
hardcore on shelf and step alike, because a quarry floor is swept whatever angle it
lies at. \id{yard} lays flags over a coursed body. \id{kiln} is one material
throughout, because a building is never the ground it stands on.
\end{minipage}}
\caption{What a theme is, seen in section. Each is the studio's own preview of the
theme, on ground the preview supplies.}
\label{fig:theme-sections}
\end{figure}
