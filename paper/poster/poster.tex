...
\vspace{12pt}
{\color{rule}\rule{\textwidth}{1pt}}\par\vspace{12pt}
...
\begin{minipage}[t]{0.315\textwidth}
  \IfFileExists{../figures/generated/maps/whitegape-iso.png}{%
    \includegraphics[width=\linewidth]{../figures/generated/maps/whitegape-iso.png}}{%
    \fcolorbox{rule}{wash}{\parbox[c][62mm][c]{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}{\centering\color{ink30}\footnotesize board render}}}\\[6pt]
  {\sffamily\bfseries\color{ink} Whitegape}\ \ {\color{ink60}destroy, 14 a side}\\[2pt]
  {\footnotesize\color{ink60} Authored from nothing, to no brief. A limestone gorge
  quarried from both rims, each team's monument on the floor of its own pit.}
\end{minipage}
\hfill
\begin{minipage}[t]{0.315\textwidth}
  \IfFileExists{../figures/generated/maps/hushwater-iso.png}{%
    \includegraphics[width=\linewidth]{../figures/generated/maps/hushwater-iso.png}}{%
    \fcolorbox{rule}{wash}{\parbox[c][62mm][c]{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}{\centering\color{ink30}\footnotesize board render}}}\\[6pt]
  {\sffamily\bfseries\color{ink} Hushwater}\ \ {\color{ink60}capture the wool, 18 a side}\\[2pt]
  {\footnotesize\color{ink60} Pulled off the composer at seed 5 and then adapted.
  The arrangement is the studio's; the place is the author's.}
\end{minipage}
\hfill
\begin{minipage}[t]{0.305\textwidth}
  {\sffamily\bfseries\color{ink} What a session looks like}\\[8pt]
  ...
  number the studio handed back.}\\[10pt]
  ...
  is the most expensive lesson in the whole corpus.}
\end{minipage}
\end{minipage}
