...
def finish():
    return {
        ...
        "themeById": {
            "piece-10-13": "keep", # the apron is the keep's own landing, not the arm's end
            "piece-10-15": "keep", # the keep
            "piece-9": "strand",   # the arm and its cape, on the axis
            "piece-5-8": "moor",   # the spawn compound, one riser under the marches
            "piece-5-9": "moor",   # both marches and both wool approaches
            "piece-5-11": "moor",  # the room's own ground
        },
        "shapePropsById": {
            # the keep and its aprons are made: out of the elevation model, flat and sheer
            "piece-10-13": {"relief_scope": "exclude"},
            "piece-10-15": {"relief_scope": "exclude"},
            # the room is a pad at the top of its ramps, and a pad does not wobble
            "piece-5-11": {"relief_scope": "hold"},
        },
        "relief": RELIEF,
