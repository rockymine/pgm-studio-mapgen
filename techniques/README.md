...
| `raising-a-lane` | ten ways up the same eight blocks — the plan, the layout, the relief and a made layer, what each climb costs a player, and what a skirt does to a lane that turns |
