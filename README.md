...
| `opus5-tarnfell` | dtm | Opus 5 | a landscape rather than a board: a tarn with a green islet in it, a wide sand shore, rolling fell, a forest, four void crevasses and a mountain backdrop that **runs off all four edges**. Thirty relief marks, four of them traced past the coast so the frame cuts a mountainside instead of ground decaying to base; every height above the rock is a **brush stroke** along the crest. One `cube-4` endstone wardstone a team, 30 right and 50 ahead of spawn, 150 apart |
